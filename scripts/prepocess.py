...
def constituency_parse(filepath, cp='', tokenize=True):
    ...
    print(cmd)
    print("constituency_parse start")
    os.system(cmd)
    print("ending!!!!!")
...
if __name__ == '__main__':
    ...
    sick_dir = os.path.join(data_dir, 'cli')
    ...
    split(os.path.join(sick_dir, 'train.txt'), train_dir)
    split(os.path.join(sick_dir, 'test.txt'), dev_dir)
    split(os.path.join(sick_dir, 'test.txt'), test_dir)
